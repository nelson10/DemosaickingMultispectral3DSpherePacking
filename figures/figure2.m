...
axis([10 10^6 0 1])
title('Density of Spheres in a (M+1)^3 Cube ', 'FontSize', fontsize,'Fontname','Times')
xlabel('V ', 'FontSize', fontsize,'Fontname','Times')
ylabel('Density ', 'FontSize', fontsize,'Fontname','Times')
legend('\rho^*[V] Upper bound (theoretical)','\rho_i[V] Optimized (Integer)','\rho_c[V] Best sphere packing (Continuous)','LineWidth',2,'location','southeast','FontSize', 16,'Fontname','Times')
